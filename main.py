...
Tweak to match your soundcard (you can see the values with PRINT_RMS_VALUES=True)
"""
...
if platform.system() == 'win32':
    ...
    # this may be more responsive
    # import win_user32_keyboard
    # keyboard = win_user32_keyboard
else:
    import pyautogui
    keyboard = pyautogui
...
KYBD_KEY = 'ctrl'
"""The key to be sent to the browser window"""
